---
title: Opciones del cuadro de di&#225;logo para la aplicaci&#243;n Rights Management sharing
ms.custom: na
ms.reviewer: na
...
-   [¿Qué es el archivo .ppdf que se crea automáticamente?](../Topic/Dialog-box-options-for-the-Rights-Management-sharing-application.md#BKMK_PPDF)

-   [¿Cuál es la diferencia entre la protección genérica y la protección incorporada (nativa)?](../Topic/Dialog-box-options-for-the-Rights-Management-sharing-application.md#BKMK_GenericNative)
...
Para obtener más información técnica, consulte la sección [Niveles de protección: nativo y genérico](../Topic/Rights-Management-sharing-application-administrator-guide.md#BKMK_LevelsofProtection) de [Guía de administrador de la aplicación de uso compartido Rights Management](../Topic/Rights-Management-sharing-application-administrator-guide.md).
